...
{
    public class RepackProcesses
    {
        public static void PrepareRepackVars(RepackVariables repackVariables, string filelistFileVar, FilelistVariables filelistVariables, string extractedDir)
        {
        ...
        public static void GetPackedState(string convertedString, RepackVariables repackVariables, string extractedDir)
        {
            ...
            else
            {
                ...
                repackVariables.OgFullFilePath = Path.Combine(extractedDir, repackVariables.OgDirectoryPath, repackVariables.OgFileName);
                repackVariables.RepackPathInChunk = repackVariables.OgMainPath.Replace(Convert.ToString(Path.DirectorySeparatorChar), "/");
            }
