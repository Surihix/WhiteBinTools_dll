...
namespace WhiteBinTools.Filelist
{
    internal class FilelistLoader
    {
        ...
        public static FilelistLoadData LoadFilelist(GameCode gameCode, string filelistFile)
        {
            var filelistLoadData = new FilelistLoadData();

            var filelistCryptHeader = new FilelistCryptHeader();
            var hasDecrypted = FilelistCrypto.DecryptProcess(gameCode, ref filelistFile, filelistCryptHeader);
